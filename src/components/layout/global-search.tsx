        ...
        >
          ...
          >
            <div className="flex items-center gap-3 border-b border-border px-4">
              ...
              <h2 id="global-search-title" className="sr-only">Search school data</h2>
              <input
                ref={inputRef}
                value={query}
            ...
            <div className="max-h-[min(28rem,60vh)] overflow-y-auto p-2">
              {query.trim().length < 2 ? (
                <div className="px-3 py-8 text-center text-sm text-text/50">
                  <GraduationCap className="mx-auto mb-2 size-5 text-text/30" aria-hidden="true" />
                  Type at least 2 characters to search school data.
                </div>
              ) : error ? (
                <div className="flex items-center gap-2 px-3 py-8 text-sm text-danger" role="alert">
                  <X className="size-4 shrink-0" aria-hidden="true" />
                  {error}
                </div>
              ) : !loading && results.length === 0 ? (
                <div className="flex items-center gap-2 px-3 py-8 text-sm text-text/50">
