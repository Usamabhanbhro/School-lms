  ...
  return (
    <div className="relative">
      <input
        ...
        className={cn(
          "h-10 w-full border border-border bg-bg px-4 pr-12 text-sm text-text placeholder:text-text/40 transition-colors duration-150 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary focus-visible:outline-none motion-reduce:transition-none",
          className,
        )}
      />
      <button
