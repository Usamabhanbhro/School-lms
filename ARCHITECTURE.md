...
> **Note:** This document is current with SRS v11 — stack rationale, role list, entity list, and deployment constraints all reflect the implemented state and the Fee Ledger extension (see `ROADMAP.md`).
