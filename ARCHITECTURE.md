...
> **Note:** This document is current with SRS v12 — stack rationale, role list, entity list, deployment constraints, Fee Ledger, and the planned backup export boundary reflect the current state (see `ROADMAP.md`).
