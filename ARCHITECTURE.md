...
> **Note:** This document is current with SRS v14 — stack rationale, role list, entity list, deployment constraints, Fee Ledger, backup export, scoped Global Search, and the presentation-only design-system completion pass reflect the current state (see `ROADMAP.md`).
