...
> **Note:** This document is current with SRS v13 — stack rationale, role list, entity list, deployment constraints, Fee Ledger, backup export, and scoped Global Search reflect the current state (see `ROADMAP.md`).
